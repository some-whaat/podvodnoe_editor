...
func _on_play_butt_pressed() -> void:
    print("_on_play_butt_pressed()")
    var pid = OS.execute("C:\\my stuff\\cpp_progects\\fish_game\\podvodne\\PODVODNOE\\fish_game\\arkiologic_game\\fish_game.exe", [], [], false)
    #var pid = OS.execute("D:/godot_stuff/PODVODNOE/podvodnoe-engine/podvodnoe_editor/game/fish_game.exe", [], [], false)
